...
Following feature requires the perl-web-markup package
<https://github.com/manakai/perl-web-markup> (L<Web::HTML::Parser> and
its family): C<inner_html>.
...
DOMImplementationList, DOMStringList, StringExtended, read-only nodes,
EntityReference, CDATASection, replaceWholeText,
