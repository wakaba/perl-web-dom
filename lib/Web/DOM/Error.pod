...
debugging purpose.  Applications should not rely on the value return
ed by this method. [DOMPERL]
...
Return the line number, in the file, of the location of the
error. [DOMPERL]
...
The class L<Web::DOM::Exception> derived from this class.
