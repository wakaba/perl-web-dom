...
L<Web::DOM::ParentNode>, and L<Web::DOM::ChildNode>, following methods
are available:
...
attributes for the element.  [DOM] [DOMATTREXODUS]

=item $string = $el->manakai_base_uri

=item $el->manakai_base_uri ($string)

Return or set the explicit [base URI] property value of the element.
[MANAKAI]
...
L<Web::DOM::HTMLElement> for details.
