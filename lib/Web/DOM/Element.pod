...
Web::DOM::Element - The DOM |Element| object
...
L<Web::DOM::RootNode>, and L<Web::DOM::ChildNode>, following methods
are available:
...
the specified name, C<undef> is returned.  [DOM3CORE]
...
Return the local name of the element.  [DOM]

=item $name = $el->manakai_local_name

Return the local name of the element.  This method is deprecated in
favor of C<local_name>. [MANAKAI]

=item $url = $el->namespace_uri

Return the namespace URL of the element.  [DOM]
...
the list and is returned by the method.  [MANAKAI]
...
DOM Living Standard <http://dom.spec.whatwg.org/#interface-element>.

=item DOMNODEEXODUS

DOM Living Standard, commented out
<view-source:http://dom.spec.whatwg.org/>.

=item DOM3CORE

Document Object Model (DOM) Level 3 Core Specification
<http://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407/DOM3-Core.html#core-ID-745549614>.

=item MANAKAI

manakai DOM Extensions
<http://suika.fam.cx/~wakaba/wiki/sw/n/manakai%20DOM%20Node%20Extensions>.
